...
/**
 * Game Features Section — alternating row layout.
 * Showcases board design, card decks, and gameplay mechanics.
 * Server Component.
 *
 * ASSET swap points are marked with // ASSET: comments.
 * Replace placeholder <div> blocks with <Image> from next/image.
 */
...
interface Feature {
  ...
  body: string;
  bullets: string[];
  imageSrc?: string;        // ASSET: populate when images are ready
  imageAlt?: string;
...
const FEATURES: Feature[] = [
  {
    ...
    placeholderEmoji: "🗺️",
    placeholderLabel: "Board overview image",
  ...
  },
  {
    ...
    body: "No boring lectures here. Draw from color-coded decks that directly affect your place on the board. Master real-world cyber concepts while managing rewards, penalties, and game-changing special items.",
    bullets: [
    ...
    placeholderEmoji: "🃏",
    placeholderLabel: "Card deck spread image",
  ...
  },
  {
    ...
    body: "Built on classic race mechanics that anyone can pick up in seconds, CYTRAC gets families talking. As players read scenarios aloud, parents and kids naturally debate choices, laugh through penalties, and internalize safety habits that stick.",
    bullets: [
    ...
    placeholderEmoji: "🎮",
    placeholderLabel: "Family gameplay image",
    ...
    >
      <div className="section-pad">
        <div className="container-content">
            ...
            {FEATURES.map(
              (
                ...
                return (
                  ...
                  >
                    {/* Image — alternates left/right via order */}
                    <div
                      className={[
                    ...
                    >
                      {imageSrc && imageAlt ? (
                        ...
                        <div className="flex aspect-4/3 w-full max-w-sm items-center justify-center rounded-2xl border border-brand-blue/10 bg-mint lg:max-w-full">
                          <div className="text-center">
                            <div className="mb-3 text-6xl">
                              {placeholderEmoji}
                            </div>
                            <p className="font-display text-sm font-bold text-forest/60">
                              {placeholderLabel}
                            </p>
                          </div>
                        </div>
                    ...
                    >
                      ...
                      <ul className="flex flex-col gap-2" aria-label={`${eyebrow} details`}>
                        {bullets.map((point) => (
          ...
          {/* Section-level CTA — catches readers who scroll past the hero */}
          <div className="mt-20 flex flex-col items-center gap-4 text-center">
            <p className="text-lg font-display font-bold text-bg-dark">
